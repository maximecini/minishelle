...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/02 18:15:38 by sle-bail          #+#    #+#             */
/*   Updated: 2025/10/16 11:15:16 by sle-bail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int	update_nodes_env(t_list *lst_env, char *key, char *new_value, char *equal)
{
	t_list	**target;
	t_env	*node;
	char	*dup_value;
