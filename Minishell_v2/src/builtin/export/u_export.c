...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/02 18:12:46 by sle-bail          #+#    #+#             */
/*   Updated: 2025/10/05 14:02:52 by rcini-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_env_name(char *start)
{
	...
	{
		if (ft_is_whitespace(start[name_len]) || (!ft_isalnum(start[name_len])
				&& start[name_len] != '_'))
			break ;
		name_len++;
	}
